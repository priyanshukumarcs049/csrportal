...
def project_view(request):
    ...
    return render(request, 'staff_template/project_view.html', context)

# def eachproject_view(request):
#     subjects = Subjects.objects.all()
#     context = {
#         "subjects": subjects
#     }
#     return render(request, 'staff_template/eachproject_view.html', context)

def eachproject_view(request, subject_id):
