...
urlpatterns = [
    ...
    path('edit_project/<project_id>/', HodViews.edit_project, name="edit_project"),
    path('edit_project_save/', HodViews.edit_project_save, name="edit_project_save"),
    path('delete_project/<project_id>/', HodViews.delete_project, name="delete_project"),
    ...
    path('staff_project_view/', StaffViews.project_view, name="project_view"),
    path('staff_eachproject_view/<subject_id>/', StaffViews.eachproject_view, name="eachproject_view"),
